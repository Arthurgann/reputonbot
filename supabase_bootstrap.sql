...
-- Create request_cache table for idempotency by X-Request-ID
...
create index if not exists idx_request_cache_chat_id_utc_day_request_id on request_cache(chat_id, utc_day, request_id);
